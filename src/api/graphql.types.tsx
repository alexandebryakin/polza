...
export function useChangeCurrentUserPasswordMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<ChangeCurrentUserPasswordMutation, ChangeCurrentUserPasswordMutationVariables>(
    ChangeCurrentUserPasswordDocument,
    options
  );
}
export type ChangeCurrentUserPasswordMutationHookResult = ReturnType<typeof useChangeCurrentUserPasswordMutation>;
export type ChangeCurrentUserPasswordMutationResult = Apollo.MutationResult<ChangeCurrentUserPasswordMutation>;
